...
function UnsplasrDesc({ img, title }) {
    return (
        <div>
            <Image width={400} height={218} src={img} alt={title} />
        </div>
    );
}
